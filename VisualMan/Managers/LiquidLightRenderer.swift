...
final class LiquidLightRenderer: MetalVisualizerRenderer {
  ...
  private var wallClock: Float = 0
  private var smoothedSpeed: Float = 0.25

  private var envelope: SIMD3<Float> = .zero
  private var slowEnvelope: SIMD3<Float> = .zero

  private var smoothedBass: Float = 0
  private var lastDropWallTime: Float = -10
  ...
  private static func liquidColor(id: Float, t: Float) -> SIMD3<Float> {
